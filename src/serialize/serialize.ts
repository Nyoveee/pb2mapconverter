...
export const serializeSpacer = () => {
	return `//->Ditto->//{"operation":"space","_visible":"1","_locked":"0","_disabled":"0"}\n`;
};

export const serializeComment = (comment: string) => {
	return `// ${comment}//->Ditto->//{"operation":"comment","comment":"${comment}","x":"0","y":"0","_visible":"0","_locked":"0","_disabled":"0"}\n`;
};
